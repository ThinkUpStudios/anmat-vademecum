        ...
        switch (v.getId()) {
            ...
            case R.id.ly_uso_racional: {
                ...
                strContent = "<p><b>Uso Racional de Medicamentos</b></p>" +
                        ...
                        "<p> • Definir el o los problemas del paciente.</p>" +
                        "<p> • Especificar los objetivos terapéuticos.</p>" +
                        "<p> • Diseñar un esquema terapéutico apropiado para cada paciente.</p>" +
                        "<p> • Escribir la receta (iniciar el tratamiento) según lo dispuesto por Ley de Promoción de la Utilización de Medicamentos por Nombre Genérico N° 25649.</p>" +
                        "<p> • Brindar información, instrucciones y advertencias.</p>" +
                        "<p> • Supervisar la evolución del tratamiento.</p>" +
